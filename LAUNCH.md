...
> 🎓 **Study + win, tonight.**
> I built a quiz app called **Lokkin** — it turns your notes into a live quiz where everyone puts in a stake, and the top 3 split the pot. Everyone else gets 80% back just for finishing, so it literally pays to show up.
